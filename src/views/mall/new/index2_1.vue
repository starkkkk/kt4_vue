  ...
  <div class="permissions-container">
    ...
    <el-row :gutter="20">
      ...
      <div class="lodash-content">
        <el-row :gutter="20">
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            <el-divider content-position="left"><h2>基于结构阻断的引导策略效果展示(李文亮事件)</h2></el-divider>
            <br>
          </el-col>
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            <el-card>
          ...
          <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
            <el-card shadow="hover">
              ...
              <img src="../image/zd_Liwenliang_1.png" width="666" height="563">
              <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
              <span style="font-size: 18px; line-height: 30px">
                <br>
          ...
          <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
            <el-card shadow="hover">
              ...
              <img src="../image/zd_Liwenliang_2.png" width="666" height="563">
              <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
              <span style="font-size: 18px; line-height: 30px">
                <br>
          ...
          <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
            <el-card shadow="hover">
              ...
              <img src="../image/zd_Liwenliang_3.png" width="666" height="563">
          ...
          <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
            <el-card shadow="hover">
              ...
              <img src="../image/zd_Liwenliang_4.png" width="666" height="563">
          ...
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            <el-card>
              <span style="font-size: 18px; line-height: 30px">
                为了直观地展示引导效果，我们展示了采用了基于结构阻断的引导策略后的网络状态图，其中左图表示执行第一步阻断桥节点后的网络状态图，
                可以看出舆情传播能够被限制在该舆情社区内部，不会扩散出去；右图表示执行第二步阻断社区内重要节点的网络状态图，可以看出在社区内部舆情传播也得到了较好的管控效果。
              </span>
            </el-card>
          </el-col>
        ...
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
          <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
            <el-card shadow="hover">
              ...
              <img src="../image/zd_Liwenliang_5.png" width="666" height="343">
          ...
          <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
            <el-card shadow="hover">
              ...
              <img src="../image/zd_Liwenliang_6.png" width="638" height="343">
...
<!--      </el-col>-->
<!--      </el-card>-->
<!--&lt;!&ndash;        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">&ndash;&gt;-->
<!--&lt;!&ndash;          <el-card>&ndash;&gt;-->
<!--&lt;!&ndash;        <div class="box">&ndash;&gt;-->
<!--&lt;!&ndash;          <div id="myChart" :style="{width: '1500px', height: '400px'}"></div>&ndash;&gt;-->
<!--&lt;!&ndash;        </div>&ndash;&gt;-->
<!--&lt;!&ndash;          </el-card>&ndash;&gt;-->
<!--&lt;!&ndash;        </el-col>&ndash;&gt;-->
<!--      </el-card>-->
